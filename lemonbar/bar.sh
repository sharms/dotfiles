...
/home/sharms/.config/lemonbar/events.py &
...
while read -r line ; do
	...
	-o -3 -f "Material Icons:size=11" -o -2 -f "Hack:Bold:size=10" -o -2 -f "Material Icons:size=13" -o -1 -B "#2E343c" -g 2560+2560+0 -u 0 -U "#2E343c" | sh
